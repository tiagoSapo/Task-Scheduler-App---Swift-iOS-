//
//  TarefasNaoRealizadasTableViewController.swift
//  Tarefas
//
...
class TarefasNaoRealizadasTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let celula = table.dequeueReusableCell(withIdentifier: "celulaNaoRealizadas", for: indexPath) as! CelulaTarefasNaoRealizadas
    ...
    func ler() -> [NSManagedObject]! {
        ...
        pedido.predicate = NSPredicate(format: "estado == 'NaoRealizada'", 0)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "mostrar", let i = tableView.indexPathForSelectedRow
        {
            ...
            vc.estado_seleccionado_segue = 0
        }
    }
}
