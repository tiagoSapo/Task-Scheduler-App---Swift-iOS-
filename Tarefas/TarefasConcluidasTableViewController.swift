...
class TarefasConcluidasTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let celula = table.dequeueReusableCell(withIdentifier: "celulaConcluidas", for: indexPath) as! CelulaConcluidas
    ...
    func ler() -> [NSManagedObject]! {
        ...
        pedido.predicate = NSPredicate(format: "estado == 'Concluida'", 0)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "mostrar", let i = tableView.indexPathForSelectedRow
        {
            ...
            vc.estado_seleccionado_segue = 2
        }
    }
}
